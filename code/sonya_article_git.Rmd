...
#view(percentage_dataframe_plot)
...
# Washington Post 2
barplot(merged_comments_plot$percentage_wapo2_article,
        names.arg = merged_comments_plot$Group,
  col = "lightblue",
  main = "washington post 2 article frequency percentage",
  xlab = "Groups",
  ylab = "Percentages"
)
barplot(merged_comments_plot$percentage_wapo2_comments,
        names.arg = merged_comments_plot$Group,
  col = "lightblue",
  main = "washington post 2 comments frequency percentage",
  xlab = "Groups",
  ylab = "Percentages"
)
#New York Times 2
barplot(merged_comments_plot$percentage_nytimes2_article,
        names.arg = merged_comments_plot$Group,
  col = "lightblue",
  main = "New York Times 2 article frequency percentage",
  xlab = "Groups",
  ylab = "Percentages"
)
barplot(merged_comments_plot$percentage_nytimes2_comments,
        names.arg = merged_comments_plot$Group,
  col = "lightblue",
  main = "New York Times 2 comments frequency percentage",
  xlab = "Groups",
  ylab = "Percentages"
)
