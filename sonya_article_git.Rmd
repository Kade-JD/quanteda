...
sonya_remove_fox1_comments <- tokens_select(sonya_nostop_fox1_comments, pattern = fox1_remove, selection = "remove")
print(sonya_remove_fox1_comments)
```
...
```{r, message=F, warning=F}
sonya.dfm.fox1.comments <- dfm(sonya_remove_fox1_comments) #put the text into a dataframe matrix
...
sonya.fox1.comments.frequency.custom <- topfeatures(sonya.fox1.comments.dfm.custom, n = 25)
...
```{r, message=F, warning=F}
sonya.dfm.fox1.comments <- dfm(sonya_remove_fox1_comments)
...
sonya_key_custom_fox1_comments <- tokens_select(sonya_remove_fox1_comments, pattern = fox_custom_key_words) #choose keywords to analyze
sonya.dfm.fox1.comments.key <- dfm(sonya_key_custom_fox1)
textplot_network(sonya.dfm.fox1.comments.key, n=20)
```
...
sonya.fox2.comments.frequency.custom <- topfeatures(sonya.fox2.comments.dfm.custom, n = 25)
...
```{r, message=F, warning=F}
dataframe.fox2.comments <- data.frame(sonya.fox2.comments.frequency.custom)
