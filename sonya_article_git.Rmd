...
textplot_influence(textplot_network(sonya.dfm.fox2.key))
```
...
filter.nytimes2.comments.categories <- filter(dataframe.nytimes2.comments.categories) #filter variables
